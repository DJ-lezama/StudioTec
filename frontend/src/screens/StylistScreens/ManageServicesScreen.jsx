...
import { PlusCircle, Search, Filter, Scissors, Hand, Eye, Tag, Clock, DollarSign, Check, X } from "lucide-react";
import catalogData, { categoryConfig } from "../../components/CatalogComponents/catalogData.js";
...
const ManageServicesScreen = () => {
    ...
    const handleToggleStatus = (id) => {
        setServices((prev) =>
            prev.map((s) => s.serviceID === id ? {...s, isActive: !s.isActive} : s)
        );
    ...
    return (
        <div className="p-6 min-h-screen bg-primaryLight">
            ...
            <div className="flex items-center justify-between mb-6">
                <h1 className="text-h3 font-heading font-bold text-textMain">Gestión de Servicios</h1>
            ...
            {sortedServices.length > 0 ? (
                <div className="bg-white rounded-xl shadow-sm overflow-hidden">
                    <div className="grid grid-cols-1 divide-y divide-gray-200">
                        ...
                        <div className="hidden md:grid md:grid-cols-12 gap-4 p-4 bg-gray-50 text-sm font-medium text-gray-500">
                            ...
                            <div className="md:col-span-1 text-center">Estado</div>
                            <div className="md:col-span-2 text-right">Acciones</div>
                        </div>

                        {/* Filas de servicios */}
                        {sortedServices.map(service => (
                            <div key={service.serviceID} className="grid grid-cols-1 md:grid-cols-12 gap-4 p-4 items-center hover:bg-gray-50">
                                ...
                                <div className="md:col-span-5 flex items-center gap-3">
                                    <div className="w-12 h-12 rounded-md overflow-hidden flex-shrink-0">
                                        <img
                                            ...
                                            onError={(e) => {
                                                e.target.src = "https://via.placeholder.com/80?text=Imagen";
                                            }}
                                        />
                                    </div>
                                    <div>
                                        <h3 className="text-sm font-medium text-textMain">{service.name}</h3>
                                ...
                                <div className="md:col-span-1 flex justify-center">
                                    <button
                                        ...
                                        className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-secondary focus:ring-offset-2 ${
                                            service.isActive ? 'bg-secondary' : 'bg-gray-200'
                                        }`}
                                    >
                                        <span
                ...
                <div className="bg-white rounded-xl shadow-sm p-8 text-center">
                    ...
                    <h3 className="text-lg font-medium text-textMain mb-2">No se encontraron servicios</h3>
                    <p className="text-gray-500 mb-4">No hay servicios que coincidan con tus criterios de búsqueda.</p>
                    <Button
                        type="dark"
                        onClick={() => {
                            setSearchTerm("");
