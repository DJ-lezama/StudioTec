        ...
        <section className="w-full bg-white relative z-10">
            <div className="max-w-6xl mx-auto px-4 sm:px-5 lg:px-5">
                <div className="text-center mb-8">
                    <h2 className="text-h2 font-bold text-textMain mb-3">
                        Encuéntranos
                    </h2>
                    <h3 className={"font-regular text-textMain mb-3"}>
                        Estamos ubicados en una zona accesible de Cholula, con
                        estacionamiento disponible y múltiples rutas de acceso.
                    </h3>
                </div>
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <p className="text-gray-600">
                                        Av 7 Pte 107A
                                        <br />
                                        Barrio de Sta. María Xixitla, 72760
                                        <br />
