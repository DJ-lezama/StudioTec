            ...
            <div className="max-w-6xl mx-auto bg-white rounded-xl shadow-md overflow-hidden">
                <div className="md:flex">
                    ...
                    <div className="md:hidden bg-primary/10 p-6 flex items-center space-x-4 border-b border-gray-100">
                        ...
                        <div>
                            <h2 className="text-lg font-semibold text-textMain">{currentUser.name}</h2>
                            <p className="text-sm text-textMain/70">{currentUser.email}</p>
                        </div>
                    </div>
                    ...
                    <main className="flex-1 p-6 md:p-8">
                        ...
                        {activeTab === "appointments" && currentUser.role === "client" && (
                            <div>
                                <h3 className="text-h4 font-heading font-semibold text-textMain mb-6">Mis citas</h3>
                                ...
                                {upcomingAppointments.length > 0 ? (
                                    ...
                                    <div className="bg-primary/5 rounded-lg p-6 text-center mb-8">
                                        <p className="text-gray-600 mb-4">No tienes citas próximas programadas</p>
                                        <Button
                                            type="dark"
                        ...
                        {activeTab === "preferences" && currentUser.role === "client" && (
                            <div>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
                    <div
                        ...
                        <div className="mb-6 bg-primary/10 p-4 rounded-lg">
                            <p className="font-medium text-textMain">{selectedAppointment.service}</p>
                            <p className="text-sm text-textMain/70">
                                <span>Cita actual: {formatDate(selectedAppointment.date)} - {selectedAppointment.time}</span>
                            </p>
                            <p className="text-sm text-textMain/70">Estilista: {selectedAppointment.stylist}</p>
                        </div>

                        {/* Selector de nueva fecha */}
                        <div className="mb-6">
                            <div className="flex justify-between items-center mb-2">
                                <h4 className="text-subtitle-s font-medium text-textMain">Selecciona nueva fecha</h4>
                            </div>
                        ...
                        {selectedDate && (
                            <div className="mb-6">
                                ...
                                <div className="grid grid-cols-3 gap-2">
                                    {["09:00", "10:00", "11:00", "12:00", "13:00", "14:00", "16:00", "17:00", "18:00"].map((time) => (
                                        <button
                                            key={time}
