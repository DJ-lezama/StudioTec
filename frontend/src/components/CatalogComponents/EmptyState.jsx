...
function EmptyState({
    ...
    message = "No hemos encontrado servicios que coincidan con tu búsqueda. Intenta con otros términos o contacta con nosotros para un servicio personalizado.",
}) {
    return (
        <div className="text-center py-10 bg-primaryLight/50 rounded-xl">
            ...
            <p className="text-textMain/70 max-w-md mx-auto">{message}</p>
        </div>
    )
}
