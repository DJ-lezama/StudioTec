...
function Button({ type = "light", children, className = "", icon, iconPosition = "right", ...props }) {
  const base = "px-4 py-2 text-sm font-medium border transition-all duration-200 flex items-center justify-center";
  ...
  const styles = {
    ...
    // Nuevas variantes
    rounded: "bg-textMain text-white border-transparent hover:bg-textMain/90 rounded-full",
    roundedLight: "bg-primary text-textMain border-transparent hover:bg-primary/90 rounded-full",
    roundedTransparent: "bg-transparent text-textMain border-textMain hover:bg-textMain hover:text-white rounded-full",
