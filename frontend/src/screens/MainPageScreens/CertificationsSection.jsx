    ...
    const certificaciones = [
        {
            ...
            imagen: certLoreal,
            descripcion:
                "Certificación en colorimetría y técnicas avanzadas de coloración",
        },
        {
            id: 2,
            nombre: "Redken",
            imagen: certRedken,
            descripcion:
                "Especialización en cortes de precisión y diseño de textura",
        },
        {
            id: 3,
            ...
            imagen: certWella,
            descripcion:
                "Certificadas en transformación capilar y tratamientos reparadores",
        },
        {
            id: 4,
        ...
        <section className="w-full relative py-16">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="text-center mb-16">
                    <h2 className="text-h2 font-bold text-[#60182D] mb-6">
                        Certificaciones que nos avalan
                    </h2>
                    <p className="text-xl text-[#3B0A20] max-w-3xl mx-auto">
                        Nuestro compromiso con la excelencia se refleja en la
                        formación continua de nuestro equipo y las
                        certificaciones que garantizan la calidad de nuestros
                        servicios.
                    </p>
                </div>
                            ...
                            <div className="relative w-full max-w-5xl h-[350px]">
                                {certificaciones.map((cert, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            <div
                                                className={`bg-gray-50 rounded-2xl overflow-hidden shadow-md w-[280px] h-full
                                            ...
                                            >
                                                <div className="p-6 flex flex-col items-center justify-between h-full">
                                                    ...
                                                    <div>
                                                        <h3 className="text-xl font-bold text-[#3B0A20] mb-3 text-center">
                                                            {cert.nombre}
                                                        </h3>
