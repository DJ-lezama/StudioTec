...
const OurSpaces = () => {
    ...
    const instalaciones = [
        {
            ...
            descripcion:
                "Espacio amplio y elegante para nuestros servicios de corte y peinado, diseñado para brindarte máxima comodidad mientras te transformamos.",
        },
        {
            id: 2,
            imagen: instalacion2,
            ...
            descripcion:
                "Sillones ergonómicos para una experiencia relajante durante el lavado. Disfruta de un masaje capilar mientras cuidan de tu cabello.",
        },
        {
            id: 3,
            imagen: instalacion3,
            ...
            descripcion:
                "Diseñada para brindarte la máxima comodidad durante tu servicio, con los mejores productos y atención personalizada.",
        },
    ...
    const prevImage = () => {
        setSelectedImage(
            (prev) => (prev - 1 + instalaciones.length) % instalaciones.length,
        )
    }
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-textMain max-w-3xl mx-auto mt-6">
                        Conoce los espacios que hemos diseñado pensando en tu
                        comodidad y en ofrecerte la mejor experiencia.
                    </p>
                </div>
            ...
            {isModalOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 transition-opacity duration-300">
                    ...
                    <button
                        ...
                        onClick={() =>
                            setLightboxIndex(
                                (prev) => (prev + 1) % instalaciones.length,
                            )
                        }
                    >
                    ...
                    <div className="absolute bottom-8 left-0 right-0 text-center text-white">
                        <h3 className="text-2xl font-bold mb-2">
                            {instalaciones[lightboxIndex].titulo}
                        </h3>
                        <p className="max-w-2xl mx-auto text-white/80">
                            {instalaciones[lightboxIndex].descripcion}
                        </p>
                    </div>
