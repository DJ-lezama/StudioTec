...
const sampleRequests = [
  {
    ...
    client: "Alina Porras",
    hairImage: "https://images.unsplash.com/photo-1580618864527-0869fced739a?ixlib=rb-4.0.3",
    referenceImage: "https://images.unsplash.com/photo-1595476108010-b4d1f102b1b1?ixlib=rb-4.0.3"
  },
  {
    id: "234567",
    service: "Limpieza de orzuela + Corte",
  ...
  },
  {
    ...
    client: "Carmen Ruiz",
    hairImage: "https://images.unsplash.com/photo-1605497788044-5a32c7078486",
    referenceImage: "https://images.unsplash.com/photo-1562322140-8baeececf3df"
  },
  {
    id: "567890",
    ...
    client: "Laura Torres",
    hairImage: null,
    referenceImage: "https://images.unsplash.com/photo-1604902396830-aca29e19b067"
  },
  {
    id: "678901",
      ...
      <div className="p-8 space-y-6 min-h-screen bg-primaryLight">
        ...
        {requests.length > 0 ? (
            ...
            <div className="bg-white p-8 rounded-xl shadow text-center">
              <h2 className="text-h4 font-heading text-textMain mb-2">No hay solicitudes pendientes</h2>
              <p className="text-textMain/70">
                Todas las solicitudes han sido procesadas. Volveremos a notificarte cuando haya nuevas solicitudes.
              </p>
            </div>
        )}
        ...
        {selectedRequest && (
            <RequestReviewOverlay
                ...
                onRespond={(response) => handleRequestResponse(selectedRequest.id, response)}
            />
        )}
      </div>
  );
